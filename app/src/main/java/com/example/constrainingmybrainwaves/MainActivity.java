...
public class MainActivity extends AppCompatActivity {
    ...
    /**
     * POC
     * @param savedInstanceState - the Bundle containing any state details needing to be preserved
     */
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView termOneBackground = new TextView(this);
...
//        termName.setLayoutParams(new ConstraintLayout.LayoutParams(ConstraintLayout.LayoutParams.WRAP_CONTENT, defaultTextHeight)); //get overwritten by constraint set... of no use
        ...
        ConstraintLayout termOneCoursesContainer = new ConstraintLayout(this);
...
//        termCoursesConstraints.setMargin(courseThreeName.getId(), ConstraintSet.BOTTOM, 35); //TODO Note the need to add padding on the last item ... Not working :(
        ...
        TextView termTwoBackground = new TextView(this);
        ...
        TextView termTwoName = new TextView(this);
        ...
        TextView termTwoDates = new TextView(this);
        ...
        ImageButton termTwoEditIcon = new ImageButton(this);
